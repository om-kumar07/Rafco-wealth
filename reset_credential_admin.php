...
<head>
    ...
    <title>Rafco - Admin reset ceredential</title>
...
<nav class="navbar navbar-light bg-light">
    ...
    <?php
       if(!$reset){
        ...
        <div>
           Wrong Security code entered !! Do you want to <a href='reset_password.html'>retry</a>
        </div>
      </div></div>";
       }
       ?>
      ...
      <symbol id='exclamation-triangle-fill' viewBox='0 0 16 16'>
        ...
        <div style='font-size:1.5rem'>
          Password Reset Successfully <a href='Admin_login.html'> Log in </a>
        </div>
      </div>";
       }
      ?>
